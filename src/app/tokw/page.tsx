...
/**
 * Token W - Earned at Drog (Location 9) - Second token from final location
 */
function TokwContent() {
  const router = useRouter();
  const [videoSrc] = useState('/videos/tokenW.mp4');
...
export default function PageTokw() {
  return (
